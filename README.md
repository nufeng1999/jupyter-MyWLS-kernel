...
[Example](https://github.com/nufeng1999/jupyter-MyWLS-kernel/blob/master/example/jupyter_MyWLS_readme.ipynb "Example")
...
cd jupyter_MyWLS_kernel && install_MyWLS_kernel --user
